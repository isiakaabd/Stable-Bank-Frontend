    ...
    <div className="bg-primary text-white_variant lg:px-16 md:px-8 px-8 pt-12 min-h-screen">
      <div className="mb-8">
        <div className="hidden md:flex flex-wrap items-center justify-between">
          ...
          <button onClick={() => setIsOpenDonateModal(true)} className="mt-4 bg-tertiary px-8 py-2 text-xl rounded">
            DONATE
          </button>
        </div>
        ...
        <div className="flex md:hidden flex-wrap items-center justify-between">
          ...
          <button className="mt-4 bg-tertiary px-20 py-2 text-xl rounded">
            DONATE
          </button>
        </div>
      </div>
      ...
      <div className="mt-8 font-mono pb-48">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Ve ro sed id
          ducimus odio, obcaecati a corrupti ab, ipsam temporibus laudantium
          modi corporis necessitatibus. Cupiditate quos magnam harum nemo, quia
          culpa. Quo vel beatae commodi, ab quos corporis. Deserunt minima, quod
          sint suscipit placeat unde sapiente nisi, illum ipsa, similique autem
          rerum eligendi vitae! Repudiandae nam eos laudantium error soluta illo
          ipsam! Dicta necessitatibus id distinctio rerum molestias cumque
          inventore eligendi magni, unde impedit voluptatem quis, debitis vero
          tempore veniam voluptas ipsum consequuntur! Incidunt soluta doloribus
          voluptatum suscipit tempore necessitatibus numquam amet ipsam
          cupiditate corporis quo quisquam accusamus, aperiam ullam repellendus.
        </p>
      </div>
    </div>
  );
